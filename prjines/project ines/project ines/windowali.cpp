...
#include "smtp.h"
Windowali::Windowali(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Windowali)
{
    ui->setupUi(this);
...
connect(ui->le_stat, &QPushButton::clicked, this, &Windowali::on_le_stat_clicked);
...
void Windowali::on_le_ajouter_clicked()
{
...
void Windowali::on_pb_supprimer_clicked()
{
...
void Windowali::on_pb_modifier_clicked()
{
...
void Windowali::on_trier_clicked()
{
    ui->tab_client->setModel(C.trierParCodeFiscale());

}

void Windowali::on_le_chercher_clicked()
{
...
void Windowali::on_le_PDF_clicked()
{
...
void Windowali::on_le_stat_clicked()
{
...
void Windowali::exportFactureToPNG(const QString &filename)
{   Client client;
...
void Windowali::on_pb_reduction_clicked()
{
    Client C;
...
void Windowali::on_afficheur_clicked()
{
...
void Windowali::mailSent(QString status)
{

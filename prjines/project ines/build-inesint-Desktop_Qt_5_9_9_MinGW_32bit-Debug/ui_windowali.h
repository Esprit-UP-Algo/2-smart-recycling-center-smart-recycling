/********************************************************************************
** Form generated from reading UI file 'windowali.ui'
**
...
#ifndef UI_WINDOWALI_H
#define UI_WINDOWALI_H
...
public:
    ...
    void setupUi(QMainWindow *Windowali)
    {
        if (Windowali->objectName().isEmpty())
            Windowali->setObjectName(QStringLiteral("Windowali"));
        Windowali->resize(1097, 697);
        centralwidget = new QWidget(Windowali);
        centralwidget->setObjectName(QStringLiteral("centralwidget"));
        tabWidget = new QTabWidget(centralwidget);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setEnabled(true);
        tabWidget->setGeometry(QRect(30, 30, 1101, 571));
        tab = new QWidget();
        ...
        label_10->setGeometry(QRect(-100, 10, 1091, 591));
        label_10->setPixmap(QPixmap(QString::fromUtf8("../../images/background.jpg")));
        cd_2 = new QLineEdit(groupBox_2);
        cd_2->setObjectName(QStringLiteral("cd_2"));
        cd_2->setGeometry(QRect(350, 520, 113, 22));
        label_10->raise();
        label_5->raise();
        label_6->raise();
        label_7->raise();
        ...
        Windowali->setCentralWidget(centralwidget);
        menubar = new QMenuBar(Windowali);
        menubar->setObjectName(QStringLiteral("menubar"));
        menubar->setGeometry(QRect(0, 0, 1097, 26));
        Windowali->setMenuBar(menubar);
        statusbar = new QStatusBar(Windowali);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        Windowali->setStatusBar(statusbar);

        retranslateUi(Windowali);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(Windowali);
    } // setupUi

    void retranslateUi(QMainWindow *Windowali)
    {
        Windowali->setWindowTitle(QApplication::translate("Windowali", "MainWindow", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("Windowali", "Ajout", Q_NULLPTR));
        label_5->setText(QApplication::translate("Windowali", "Code_fiscale", Q_NULLPTR));
        label_6->setText(QApplication::translate("Windowali", "Mail", Q_NULLPTR));
        label_7->setText(QApplication::translate("Windowali", "Adresse", Q_NULLPTR));
        le_ajouter->setText(QApplication::translate("Windowali", "Ajouter", Q_NULLPTR));
        pb_modifier->setText(QApplication::translate("Windowali", "modifier", Q_NULLPTR));
        label_2->setText(QApplication::translate("Windowali", "Sexe", Q_NULLPTR));
        label_4->setText(QApplication::translate("Windowali", "Nombre de commande", Q_NULLPTR));
        trier->setText(QApplication::translate("Windowali", "trier", Q_NULLPTR));
        le_PDF->setText(QApplication::translate("Windowali", "exporter PDF", Q_NULLPTR));
        label_3->setText(QApplication::translate("Windowali", "rechercher selon l'adresse mail:", Q_NULLPTR));
        le_chercher->setText(QApplication::translate("Windowali", "chercher", Q_NULLPTR));
        afficheur->setText(QApplication::translate("Windowali", "PushButton", Q_NULLPTR));
        label->setText(QApplication::translate("Windowali", "Code fiscale du client:", Q_NULLPTR));
        pb_supprimer->setText(QApplication::translate("Windowali", "Supprimer", Q_NULLPTR));
        le_stat->setText(QApplication::translate("Windowali", "statistiques", Q_NULLPTR));
        label_10->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("Windowali", "Ajouter un client", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab4), QApplication::translate("Windowali", "statistiques des commandes", Q_NULLPTR));
        label_8->setText(QApplication::translate("Windowali", "Code fiscale du client:", Q_NULLPTR));
        pb_reduction->setText(QApplication::translate("Windowali", "calculer reduction", Q_NULLPTR));
        PNG->setText(QApplication::translate("Windowali", "exporter PNG", Q_NULLPTR));
        label_9->setText(QApplication::translate("Windowali", "le code:", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("Windowali", "reduction et facture", Q_NULLPTR));
        label_11->setText(QApplication::translate("Windowali", "stmp server:", Q_NULLPTR));
        label_12->setText(QApplication::translate("Windowali", "Server port:", Q_NULLPTR));
        label_13->setText(QApplication::translate("Windowali", "Username:", Q_NULLPTR));
        label_14->setText(QApplication::translate("Windowali", "Password:", Q_NULLPTR));
        label_15->setText(QApplication::translate("Windowali", "Recipant to:", Q_NULLPTR));
        label_16->setText(QApplication::translate("Windowali", "Subject:", Q_NULLPTR));
        label_17->setText(QApplication::translate("Windowali", "Message:", Q_NULLPTR));
        server->setText(QApplication::translate("Windowali", "smtp.gmail.com", Q_NULLPTR));
        port->setText(QApplication::translate("Windowali", "465", Q_NULLPTR));
        sendBtn->setText(QApplication::translate("Windowali", "Send", Q_NULLPTR));
        label_18->setText(QApplication::translate("Windowali", "Browse:", Q_NULLPTR));
        browseBtn->setText(QApplication::translate("Windowali", "Browse...", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("Windowali", "Email", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class Windowali: public Ui_Windowali {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WINDOWALI_H

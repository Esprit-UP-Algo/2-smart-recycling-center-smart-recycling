...
Windowsakouhi::Windowsakouhi(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::Windowsakouhi)
{
    ui->setupUi(this);
...
Windowsakouhi::~Windowsakouhi()
{
    delete ui;
}


void Windowsakouhi::on_pb_ajouter_clicked()
{
...
void Windowsakouhi::on_pb_supprimer_clicked()
{
    Employe E1 ;
...
void Windowsakouhi::on_pb_modifier_clicked()
{
    int id=ui->le_id->text().toInt();
    int num_telephone=ui->le_num_telephone->text().toInt();
    int nbre_enfant=ui->le_nbre_enfant->text().toInt();
...
void Windowsakouhi::on_pb_chercher_clicked()
...
void Windowsakouhi::on_pb_trier_clicked()
{
...
void Windowsakouhi::on_pb_pdf_clicked()
{
...
void Windowsakouhi::on_pb_stat_clicked()
{
...
/*void Windowsakouhi::on_pushButton_clicked()
{
    QString identifiant = ui->lineEdit_identifiant->text();
...
void Windowsakouhi::generatePieChart()
{
...
void Windowsakouhi::on_pb_sat2_clicked()
...
/*void Windowsakouhi::update_label()
{
...
void Windowsakouhi::on_pb_back3_clicked()
{
